...
export const helpCategories: HelpCategory[] = [
  {
    ...
    articles: [
      ...
      },
      {
        ...
        a: `Yes. Spektt is free to download and use. You can follow people, post content, join Clusters, and enter Showdowns for free. Free accounts have an upload limit — once you reach it, you'll need to upgrade to Spektt Pro to keep posting. Pro also unlocks additional features across the app. See the Subscriptions & Pro section for details.`,
      },
      {
        q: 'What creative categories does Spektt support?',
        a: `Currently: Photography, Videography, 3D Animation, Sound Engineering, and Digital Artistry. You choose your primary category during onboarding and can update it anytime from your profile settings. We'll be adding more creative categories as Spektt grows.`,
      },
      {
    ...
    articles: [
      {
        ...
        a: `Your profile shows your display name, username, creative category, location, and profile photo, along with your follower/following count and total views. Below that are tabs for your content: Spotlights, Uploads, Collections, Milestones, Awards, and Bookmarks. Visitors to your profile can see your Spotlights, Uploads, and Awards tabs.`,
      },
      {
      ...
      },
      {
        ...
        a: `Collections are curated sets of your posts — like albums. Group your work by theme, project, or style. Free accounts can have a limited number of Collections; upgrade to Spektt Pro for more. Collections are visible on your own profile only — they are not shown to visitors.`,
      },
      {
      ...
      },
      {
        ...
        a: `The Milestones tab shows your XP progress and all 29 badges on Spektt — both earned and unearned (with progress bars so you know how close you are). At the top you'll see your current level, tier name, total XP, and a progress bar to the next level. Tap "See All" to open the full Milestones screen. Milestones are visible on your own profile only.`,
      },
      {
        q: 'What is Showdown Watch?',
        a: `Showdown Watch lets you bookmark a Showdown entry — yours or anyone else's — to follow its journey. Save an entry before voting closes and come back to see how it performs through voting, judging, and final results. All tracked from a dedicated section on your profile.`,
      },
      {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        a: `Settings → Account → Delete Account. This starts a 30-day grace period — your account is deactivated but not erased. Log back in within 30 days to fully restore it. After 30 days, all data is permanently deleted and cannot be recovered.`,
      },
      {
        q: 'I forgot my password. How do I reset it?',
        a: `On the login screen, tap "Forgot Password." Enter your email — we'll send a reset link. Check your spam folder if it doesn't arrive within a few minutes.`,
      },
      {
        q: 'How do I log out?',
      ...
      },
      {
        ...
        a: `Email support@spektt.com. We read every message and use feedback to improve the app.`,
      },
    ],
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        a: `Photos: up to 10MB, and a minimum resolution of 4 megapixels (roughly 2000×2000px or better) — very low-resolution images are rejected. Videos: up to 50MB, maximum 5 minutes. You'll see a clear error message if a file doesn't meet these limits before you submit.`,
      },
      {
        q: 'How do I upload a post?',
        a: `Tap the "+" button in the bottom navigation. Choose New Upload, then select the media type (image or video) from your media library. Add a caption, select a category, and optionally tag a Cluster. Tap "New Upload" to publish.`,
      },
      {
      ...
      },
      {
        ...
        a: `Photos are delivered via Cloudflare Images (global CDN). Videos are streamed via Cloudflare Stream. This ensures fast loading for viewers anywhere in the world.`,
      },
      {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        a: `Purely by fan votes. When voting closes:\n• Entries are sorted by vote count (highest first).\n• If two entries have equal votes, the one with more views ranks higher.\n• If votes and views are still tied, the entry submitted earlier ranks higher.\n\nThe top 15 entries are displayed in the final rankings.`,
      },
      {
        q: 'How are winners chosen in a Premium Showdown?',
        a: `In two stages:\n\nFan vote — The community votes to determine the top 20 entries. These become the finalists that go to the judges.\n\nJudge scoring — A panel of expert judges scores each of those top 20 entries on defined criteria (0–10 per criterion).\n\nThe final ranking combines both: fan vote performance counts for 50%, judge scores count for 50%. The entry with the highest combined score wins. Top 15 are displayed in the final results.`,
      },
      {
      ...
      {
        q: 'What is Showdown Watch?',
        a: `Showdown Watch lets you bookmark any Showdown entry — yours or anyone else's — to follow it through the full lifecycle. Saved entries appear in a dedicated section of your profile. Great for tracking your own submission or following a creator you're rooting for.`,
      },
      {
        q: 'How do I save an entry to Showdown Watch?',
        a: `Tap the bookmark icon on any Showdown entry. It's saved to your Showdown Watch section on your profile. Tap again to remove it.`,
      },
      {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        a: `Tap the "+" button in the bottom navigation and select "New Cluster." Creating a Cluster requires a Spektt Pro subscription or reaching level 51.\n\nIf you haven't met either requirement, the option will appear in the menu but will be locked — you'll see a PRO badge on it. Once you're eligible, tap it to open the setup form: fill in your Cluster name, description, category, and cover image. Once created, you're automatically the Cluster admin.`,
      },
      {
    ...
    articles: [
      {
        ...
        a: `The Leaderboard ranks all Spektt users by their total XP (experience points). It shows where you stand against the entire Spektt community and is refreshed every 7 days.`,
      },
      {
        q: 'How is my rank calculated?',
        a: `Your rank is based on your total XP. The more active and engaged you are — posting, getting engagement, winning Showdowns, earning badges — the higher your rank.`,
      },
      {
      ...
      },
      {
        ...
        a: `Rankings refresh every 7 days. Your XP accumulates continuously, but the ranked positions update on a weekly cycle.`,
      },
      {
        q: 'Can I lose rank?',
        a: `Your absolute XP never decreases, but your relative rank can drop if other users earn XP faster than you. Stay active to hold your position.`,
      },
      {
        q: 'What does the rank position mean for my profile?',
        a: `Your Leaderboard position is visible to other users on your profile. Top-ranked creators gain more visibility across the platform.`,
      },
    ],
    ...
    articles: [
      {
        ...
        a: `Spektt Pro is our optional subscription that unlocks premium features: priority visibility in feeds, an exclusive Pro subscriber badge, unlimited uploads, unlimited Spotlights, and additional benefits as we grow.`,
      },
      {
      ...
      },
      {
        ...
        a: `Settings → "Become a Spektt Pro" → choose a plan (monthly or annual) → complete payment through the App Store (iOS) or Google Play (Android). Your subscription activates immediately.`,
      },
      {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        a: `In your Inbox, swipe left on the conversation and select "Delete."`,
      },
      {
  ...
  },
  {
    ...
    articles: [
      {
        q: 'What are badges?',
        a: `Badges are recognitions for achievements and milestones on Spektt. We have 29 badges across categories: posting milestones, Showdown placements (1st/2nd/3rd), tier achievements, community engagement, and special events. Badges are permanent once earned.`,
      },
      {
      ...
      {
        q: 'What are Tiers?',
        a: `Tiers are progression levels based on your XP:\n• Newcomer — Just getting started\n• Rising — Growing your presence\n• Established — Active community member\n• Pro — Recognised creator\n• Elite — Top of the Spektt community\n\nYour current tier is displayed on your profile.`,
      },
      {
        q: 'How do I earn XP?',
        a: `XP is earned across several areas:\n• Signing up — one-time XP bonus when you create your account\n• Views — XP awarded when your uploads hit view milestones (100, 1K, 10K, 100K, 1M views)\n• Voting in Showdowns — XP for each vote you cast (up to 20 votes per day)\n• Entering a Showdown — XP just for submitting an entry\n• Placing in a Showdown — finishing in the top 15 earns XP; top 3 pays significantly more; 1st place pays the most\n• Joining a Cluster — XP bonus when you join\n• Creating a Cluster — XP bonus when you start your own Cluster\n• Growing your Cluster — XP as your Cluster reaches member milestones\n• Earning badges — some badges come with an XP reward when unlocked\n\nSpektt Pro users earn 25% more XP on everything.`,
      },
      {
        q: 'Can I lose XP?',
        a: `No. Your XP total only ever goes up. Your Leaderboard rank relative to others may change as the community grows, but your XP itself never decreases.`,
      },
      {
        q: 'Do badges expire?',
      ...
      },
      {
        ...
        a: `Yes. Contest win badges and tier badges are prestige-only — no XP, just the recognition. The rarest ones go to Showdown winners and users who reach the top tier (level 51+).`,
      },
      {
        q: 'Does Spektt Pro affect my XP or tier?',
        a: `Yes — Spektt Pro gives you a 25% XP boost on everything you earn. Tiers and levels are still based entirely on your activity, so Pro users climb faster but the system is the same for everyone.`,
      },
    ],
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        a: `Our moderation team reviews every report. If we confirm a violation, we take action: removing content, issuing a warning, suspending, or banning the account. You'll receive a notification once your report has been reviewed.`,
      },
      {
      ...
      },
      {
        ...
        a: `You'll see a message explaining why when you try to log in. If you believe the suspension was a mistake, contact support@spektt.com with your username and we'll review it.`,
      },
      {
